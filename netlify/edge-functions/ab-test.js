...
async function handleRequest(request) {
  ...
  const abConfig = {
    variants: [
      {
        name: "Normal Page",
        url: "https://splendorous-croquembouche-00ea76.netlify.app/",
        script: "",
      },
      {
        name: "Modified Page",
        url: "https://vermillion-marshmallow-e3f677.netlify.app/",
        script: "",
      },
    ],
    rule: {
      ...
      destinations: [
        {
          variantName: "Normal Page",
          weight: "50",
        },
        {
          variantName: "Modified Page",
          weight: "50",
        },
      ],
      note: "",
